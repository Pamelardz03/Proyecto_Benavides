              ...
              <div key={paciente.id} className="relative overflow-hidden rounded-[2rem]">
                ...
                >
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    <a href={`tel:${paciente.telefono}`} onClick={(e) => e.stopPropagation()}
                      className="p-2.5 rounded-2xl bg-gray-50 text-gray-400 hover:bg-green-50 hover:text-green-600 transition-all">
                      <Phone className="w-4 h-4" />
                    </a>
                    <button onClick={(e) => { e.stopPropagation(); setSelectedPaciente(paciente); setShowEmailModal(true); }}
                      className="p-2.5 rounded-2xl bg-gray-50 text-gray-400 hover:bg-blue-50 hover:text-blue-600 transition-all">
                      <Mail className="w-4 h-4" />
                    </button>
                    <button onClick={(e) => { e.stopPropagation(); navigate(`/colaborador/paciente/${paciente.id}`); }}
                      className="p-2.5 rounded-2xl bg-[#001389] text-white hover:bg-[#001389]/90 shadow-lg transition-all">
