...
export function Register() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Register:', { ...formData, userType: selectedUserType });
    
    // Después del registro, ir a verificación
            ...
            <div className="relative bg-white/70 backdrop-blur-2xl rounded-3xl p-8 md:p-10 shadow-2xl border border-white/60">
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">
                  Regístrate como {getUserTypeLabel(selectedUserType).toLowerCase()}
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white/50 backdrop-blur-sm border border-gray-200/60 focus:border-[#001389] focus:ring-2 focus:ring-[#001389]/20 transition-all duration-300 outline-none"
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-white/50 backdrop-blur-sm border border-gray-200/60 focus:border-[#001389] focus:ring-2 focus:ring-[#001389]/20 transition-all duration-300 outline-none pr-12"
                      placeholder="••••••••"
                      required
                    />
                    <button
                ...
                <div className="flex items-start gap-2">
                  <input
                    type="checkbox"
                    id="terms"
                    className="w-4 h-4 mt-0.5 rounded border-gray-300 text-[#001389] focus:ring-[#001389]/20"
                    required
                  />
                  <label htmlFor="terms" className="text-sm text-gray-600">
                    Acepto los{' '}
                    <button type="button" className="text-[#001389] hover:underline">
